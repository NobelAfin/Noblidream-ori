class UsuariosController < ApplicationController
  ...
  private
    ...
    def usuario_params
      params.require(:usuario).permit(:nombre, :apellido_paterno, :apellido_materno, :fecha_de_nacimiento, :telefono, :estado_civil, :sexo, :escolaridad, :estado, :municipio, :domicilio, :numero_exterior, :numero_interior, :codigo_postal, :correo, :confirmar_correo, :contraseña, :confirmar_contraseña)
    end
end
